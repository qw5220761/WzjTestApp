...
public class UpdateIntentService extends IntentService {
    ...
    public void createNotification() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            builder = new NotificationCompat.Builder(MyApplication.getApplication());
//            builder = new NotificationCompat.Builder(MyApplication.getApplication(), mChannelId);
    ...
    public Intent getFileIntent(File file) {
        Uri uri = FileUtils.getUriForFile(getBaseContext(), file);
